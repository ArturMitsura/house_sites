(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".review-page__slider")) new core(".review-page__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
    ...
    const menuSearch = document.querySelector(".menu__button");
    const menuForm = document.querySelector(".menu__form-body");
    menuSearch.addEventListener("click", (function() {
        menuForm.classList.toggle("form_open");
    }));
        ...
        async function formSend(e) {
            ...
            if (0 === error) {
                ...
                if (response.ok) {
                    ...
                    formPreview.addEventListenerHTML = "";
                    form.reset();
                    form.classList.remove("_sending");
                } else {
                    alert("Отправка формы отключена до загрузки сайта на сервер");
                    form.classList.remove("_sending");
                }
            } else alert("Заполните корректно обязательные поля");
        }
